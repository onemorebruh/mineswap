...
const val SAFE_SQUARES: Int = 71;
const val MAX_FLAGS: Int = 10; //NOTE have to be equal to MAX_BOMBS
const val MAX_BOMBS: Int = 10; //NOTE have to be equal to MAX_FLAGS
